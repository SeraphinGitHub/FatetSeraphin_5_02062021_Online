...
class CartClass {
    ...
    async purchase(event) {
        ...
        // ****************************************************
        // Modified for _Online
        // ****************************************************
        let contactEmpty = Object.values(contact).includes("");

        // If cart isn't empty
        if(products.length && !contactEmpty) {

            const r1 = Math.random().toString(16).substr(2, 6);
            const r2 = Math.random().toString(16).substr(2, 6);
            const r3 = Math.random().toString(16).substr(2, 6);
            const r4 = Math.random().toString(16).substr(2, 6);
            const r5 = Math.random().toString(16).substr(2, 6);
            
            const orderId = `${r1}-${r2}-${r3}-${r4}-${r5}`;
